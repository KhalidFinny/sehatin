...
export class DasborAdmin implements OnInit {
  ...
  constructor(private title: Title, private meta: Meta) {
    ...
    this.meta.addTags([
      { name: "description", content: "Dasbor Admin" },
      { property: "og:title", content: "Dasbor Admin" },
      { property: "og:description", content: "Dasbor Admin" },
      { property: "twitter:title", content: "Dasbor Admin" },
      { property: "twitter:description", content: "Dasbor Admin" },
    ]);
  }
